...
It contains the following items:
	...
	/source						---> this folder will contain your solutions for server1 (mandatory) and client1/server2 (optional)
	dp1_socket_jul17.pdf				---> the text of the exam
	dp1_socket_jul17_ita.pdf			---> the text of the exam (Italian version)
...
To create the final .zip file containing your solution, please use the following command:
./makezip.sh
and do not move the generated socket.zip file.
